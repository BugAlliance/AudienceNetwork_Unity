...
namespace AudienceNetwork
{
    ...
    internal class RewardedVideoAdBridgeIOS : RewardedVideoAdBridge {
        ...
        [DllImport ("__Internal")]
        private static extern void FBRewardedVideoAdBridgeOnComplete(int uniqueId,
        FBRewardedVideoAdBridgeExternalCallback callback);
        ...
        RewardedVideoAd rewardedVideoAd)
        {
            ...
            RewardedVideoAdBridgeIOS.FBRewardedVideoAdBridgeOnComplete (uniqueId, rewardedVideoAdCompleteBridgeCallback);
